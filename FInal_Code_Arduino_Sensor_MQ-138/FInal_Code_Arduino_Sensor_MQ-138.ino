...
const uint64_t pipeNum = 0x7878787855; //ADDRESS
...
void loop() 
{
  ...
  int sensorValue1 = map(analogRead(A1),0,1023,0,255); //sensor 1


  //********===SENSOR 2 & DATA ACQUISITION AND CONVERSION===********//

  int sensorValue2 = 0; //map(analogRead(A2),0,1023,0,255); //sensor 2

  //********===Data Compilation===********//
  Array[0] = map(analogRead(A1),0,1023,0,255);
  Array[1] = map(analogRead(A2),0,1023,0,255);
